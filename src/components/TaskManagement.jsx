...
const TaskManagement = () => {
      ...
      t => (
        <div className="bg-white dark:bg-gray-800 p-4 rounded-lg shadow-lg">
          ...
          <div className="flex justify-end gap-2 mt-4">
            <button
              className="bg-red-500 hover:bg-red-600 text-white cursor-pointer px-4  rounded transition duration-300"
              onClick={async () => {
                try {
            ...
            <button
              className="bg-gray-300 hover:bg-gray-400 cursor-pointer text-gray-800 dark:text-gray-900 px-4  rounded transition duration-300"
  ...
  const handleDragEnd = async event => {
    ...
    if (activeTask.category !== newCategory) {
      ...
      const newCategoryTasks = updatedTasks.filter(
      ...
      updatedTasks = arrayMove(categoryTasks, oldIndex, newIndex).map(
        (task, index) => ({
          ...task,
          order: index,
        })
